...
for i = 1 : im_num
    ...
    for nh = listh
        for nw = listw
            ...
            while Continue
                fprintf('Iter: %d \n', nOuterLoop);
                [IMout_part_y, PN] = bscdl_BID_P(IMin_part_y,model,Dict,par,param);
    ...
    %% output
    imwrite(IMout, ['./DSCDL_BID_AN_ADPU/DSCDL_BID_AN_ADPU_P_nup0.5_' type '_' IMname '_nup' num2str(par.nup) '.png']);
end