...
for nup = 0.2:0.2:2
    ...
    for i = 1 : im_num
        ...
        %% output
        imwrite(IMout, ['./DSCDL_BID_AN_ADPU_AP/ADPU_nup0.5_AP_DSCDL_BID_AN_' type '_' IMname '_nup' num2str(nup) '.png']);
        fprintf('The Loops of these parts are  %s. \n', num2str(nOuterLoop));
        Loops = nOuterLoop*par.nInnerLoop;
        save(['./DSCDL_BID_AN_ADPU_AP/ADPU_nup0.5_AP_DSCDL_BID_AN_' IMname '_nup' num2str(nup) '_Loops.mat'],'Loops','PN');
    end
end