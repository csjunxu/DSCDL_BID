...
for i = 51 : par.cls_num
    ...
    Dini{i} = D;
    clear D;
    Dict_BID_Initial = sprintf('Data/temp_BID_Dict_BCGD_ADPU_DSCDL_Initial_51_100.mat');
    ...
    Dict_BID_backup = sprintf('Data/temp_BID_Dict_BCGD_ADPU_DSCDL_backup_51_100.mat');
