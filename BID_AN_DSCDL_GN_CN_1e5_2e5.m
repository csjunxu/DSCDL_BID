...
model.net = getfield(load('./GatingNetwork/GatingNet_knnNI2BS500_1e5_2e5_4000.mat'),'net');
...
for i = 1:im_num
    ...
    %% output
    imwrite(IMout, ['./DSCDL_BID_AN_GN_CN/DSCDL_BID_AN_GN_CN_1e5_2e5_4000_' type '_' IMname '.png']);
end
...
%% load pre-trained models (see demoTrain.m for training models)
model = getfield(load('Data/EMGM_8x8_100_knnNI2BS500Train_20160722T082406.mat'),'model');
model.net = getfield(load('./GatingNetwork/GatingNet_knnNI2BS500_1e5_2e5_5000.mat'),'net');
%% the whole image or part
type = 'all';
% 'random';
% 'middle';
...
for i = 1:im_num
    ...
    %% output
    imwrite(IMout, ['./DSCDL_BID_AN_GN_CN/DSCDL_BID_AN_GN_CN_1e5_2e5_5000_' type '_' IMname '.png']);
end