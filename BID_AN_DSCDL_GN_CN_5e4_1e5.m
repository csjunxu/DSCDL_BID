...
model.net = getfield(load('./GatingNetwork/GatingNet_knnNI2BS500_5e4_1e5_2000.mat'),'net');
...
for i = 1:im_num
    ...
    %% output
    imwrite(IMout, ['./DSCDL_BID_AN_GN_CN/DSCDL_BID_AN_GN_CN_5e4_1e5_2000_' type '_' IMname '.png']);
end
