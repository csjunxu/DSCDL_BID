...
for i = par.cls_num : -1 : 51
    ...
    Dini{i} = D;
    clear D;
    Dict_BID_Initial = sprintf('Data/temp_BID_Dict_BCGD_ADPU_DSCDL_Initial_100.mat');
    ...
    Dict_BID_backup = sprintf('Data/temp_BID_Dict_BCGD_ADPU_DSCDL_backup_100.mat');
