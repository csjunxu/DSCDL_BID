...
for i = 1:im_num
    ...
    %% output
    imwrite(IMout, ['./DSCDL_BID_AN/DSCDL_BID_AN_' type '_' IMname '.png']);
    fprintf('The Loops of these parts are  %s. \n', num2str(nOuterLoop));
    Loops = nOuterLoop*par.nInnerLoop;
    save(['./DSCDL_BID_AN/DSCDL_BID_AN_' IMname '_Loops.mat'],'Loops');
end
