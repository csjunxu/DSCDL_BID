...
for i = 50 : -1 : 1
    ...
    Dini{i} = D;
    clear D;
    Dict_BID_Initial = sprintf('Data/temp_BID_Dict_BCGD_ADPU_DSCDL_Initial_50_1.mat');
    ...
    Dict_BID_backup = sprintf('Data/temp_BID_Dict_BCGD_ADPU_DSCDL_backup_50_1.mat');
