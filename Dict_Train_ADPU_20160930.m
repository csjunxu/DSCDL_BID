...
for i = 1 : par.cls_num
    ...
    Dini{i} = D;
    Dict_BID_Initial = sprintf('Data/DSCDL_Dict_PG_BID_Initial_20160930T171410_%s.mat', datestr(now, 30));
    ...
    Dict.PN{i} = Pn;
    Dict.f{i} = f;
    Dict_BID_backup = sprintf('Data/DSCDL_ADPU_Dict_PG_BID_backup_20160930T171410_%s.mat',datestr(now, 30));
